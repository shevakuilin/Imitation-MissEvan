...
- (XHSegmentControl *)segmentControl
{
    if (!_segmentControl)
    {
        ...
        _segmentControl = [[XHSegmentControl alloc] initWithFrame:CGRectMake(60, y, [UIScreen mainScreen].bounds.size.width - 120, DefaultSegmentHeight)];//segmentController宽高
